    ...
    <section id="contact" className="py-20 lg:py-32 bg-white">
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="w-screen flex justify-center item-center overflow-hidden">
          <div className="overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white rounded-3xl p-10 lg:p-14 shadow-2xl border border-slate-700 bg-amber-500">
            <div className="mb-2">
