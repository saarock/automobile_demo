...
export function HeroSection() {
  ...
  const handleCallbackSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (phone) {
      window.location.href = `https://wa.me/61${phone.slice(1)}?text=Hi%20Alfa%20Automotive,%20I%20would%20like%20to%20book%20a%20mobile%20service.`;
      setPhone('');
  ...
  return (
    <section className="relative bg-white py-20 lg:py-32 min-h-screen flex items-center overflow-hidden">
      <div className="absolute inset-0 overflow-hidden">
        <img
          src="/mobile-service-van-mechanics-working-on-car.jpg"
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        <div className="max-w-3xl">
          ...
          <h1 className="text-5xl lg:text-7xl font-black text-foreground leading-[1.15] mb-6 tracking-tight animate-slide-up">
            ...
            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-primary via-primary to-accent mt-3 animate-slide-up" style={{ animationDelay: '0.2s' }}>
              We Come to You
            </span>
          </h1>
          
          <p className="text-lg lg:text-xl text-foreground/70 leading-relaxed mb-6 max-w-2xl font-light animate-fade-in" style={{ animationDelay: '0.4s' }}>
            Our fully equipped service vans bring expert mechanics directly to your home, workplace, or roadside. No more waiting in service centers - we deliver convenience to you across all Canberra & ACT.
          </p>
          ...
          {showCallback && (
            <div className="animate-slide-up bg-primary/5 border border-primary/20 rounded-2xl p-6 mb-8">
              <form onSubmit={handleCallbackSubmit} className="flex flex-col sm:flex-row gap-3">
                <input
                  type="tel"
              ...
              <p className="text-xs text-foreground/60 mt-3">We'll respond instantly via WhatsApp</p>
            </div>
          )}

          <div className="grid grid-cols-3 gap-8 pt-12 border-t border-foreground/10 animate-fade-in" style={{ animationDelay: '0.8s' }}>
            <div className="group">
              <div className="text-3xl font-black text-primary mb-2">24/7</div>
              <div className="text-xs text-foreground/60 tracking-wide uppercase font-semibold">Emergency Service</div>
            </div>
            <div className="group">
              <div className="text-3xl font-black text-accent mb-2">All ACT</div>
              <div className="text-xs text-foreground/60 tracking-wide uppercase font-semibold">Including Queanbeyan</div>
            </div>
            <div className="group">
              <div className="text-3xl font-black text-primary mb-2">30min</div>
              <div className="text-xs text-foreground/60 tracking-wide uppercase font-semibold">Avg Response Time</div>
            </div>
          </div>
        </div>
      </div>
