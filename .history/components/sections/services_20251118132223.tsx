...
export function ServicesSection() {
  return (
    <section id="services" className="py-20 lg:py-32 bg-gradient-to-b from-white to-muted/20">
      <div className="container mx-auto px-6 lg:px-12">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <h2 className="text-4xl lg:text-6xl font-black text-foreground mb-6 tracking-tight">
            ...
            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-primary to-accent mt-2">Simplified View</span>
          </h2>
          <p className="text-lg text-foreground/60 max-w-3xl mx-auto leading-relaxed">
            Quick overview of our most popular services. For detailed information and pricing, visit our services page.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {services.slice(0, 6).map((service, index) => (
            ...
            >
              ...
              <p className="text-foreground/60 mb-6 leading-relaxed text-sm">{service.description}</p>
              
              <div className="flex items-center justify-between text-sm font-medium">
                <span className="text-primary font-black">{service.price}</span>
                <span className="text-foreground/50">⏱️ {service.duration}</span>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="mt-16 bg-gradient-to-br from-primary/5 to-accent/5 rounded-3xl p-12 border border-primary/10">
          <div className="grid md:grid-cols-3 gap-12">
            <div className="text-center group">
              ...
              <p className="text-foreground/60 text-sm">Professional mechanics</p>
            </div>
